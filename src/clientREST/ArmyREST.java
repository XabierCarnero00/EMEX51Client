...
public class ArmyREST {
    ...
    public <T> T findArmyBySector(Class<T> responseType, String sectorId) throws WebApplicationException {
        WebTarget resource = webTarget;
    ...
    public <T> T findArmyByName(Class<T> responseType, String name) throws WebApplicationException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("name/{0}", new Object[]{name}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_XML).get(responseType);
    }

    public <T> T findAllArmys(Class<T> responseType) throws WebApplicationException {
        WebTarget resource = webTarget;
